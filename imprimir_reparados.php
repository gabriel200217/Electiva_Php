<?php 
    ...
    $sql="SELECT * FROM equipos WHERE estado='Reparado' AND fecha BETWEEN '$fecha_inicio' AND '$fecha_final'";
...
<body>
    <div style="width: 100%; text-align: center">
        <h3>
            Reporte de equipos reparados desde
            <br>
            <h2>
...
$dompdf->render();
$pdf = $dompdf->output();
$filename = "Reporte_Equipos_Reparados.pdf";
