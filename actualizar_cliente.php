    ...
    <body>
                <div class="container mt-5">
                    <form action="update_cliente.php" method="POST">
                                ...
                                <input type="text" class="form-control mb-3" name="rif_ced" value="<?php echo $row['rif_ced']  ?>">
                                <input type="text" class="form-control mb-3" name="cliente" value="<?php echo $row['cliente']  ?>">
                                <input type="text" class="form-control mb-3" name="contacto" value="<?php echo $row['contacto']  ?>">
