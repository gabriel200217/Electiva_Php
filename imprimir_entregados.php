<?php 
    ...
    $sql="SELECT * FROM equipos WHERE estado='Finalizado' AND fecha BETWEEN '$fecha_inicio' AND '$fecha_final'";
...
<body>
    <div style="width: 100%; text-align: center">
        <h3>
            Reporte de equipos entregados desde
            <br>
            <h2>
...
<table width="100%" cellpadding="5px" cellspacing="5px" border="1">
    ...
    <tr >
        ...
        <td><?php if($row['estado'] = 'Finalizado'){?><?php echo 'Entregado'?><?php }?></td>
