...
<html lang="en">
    ...
    <body>
                <div class="container mt-5">
                    ...
                    ?>
                    <form action="Insertar_reparar.php" method="POST">
                        ...
                        <input type="text" class="form-control mb-3" name="comentario" placeholder="comentario" value="<?php echo $row['material1']  ?>" disabled>
                        <input type="text" class="form-control mb-3" name="comentario" placeholder="comentario" value="<?php echo $row['material2']  ?>" disabled>
                        <input type="text" class="form-control mb-3" name="comentario" placeholder="comentario" value="<?php echo $row['material3']  ?>" disabled>
                        ...
                        <input type="submit" class="btn btn-primary btn-block" value="Entregado" disabled>
                    ...
                    <form action="Insertar_reparar.php" method="POST">
                        ...
                        <input type="submit" class="btn btn-primary btn-block" value="Reparado" disabled>
                        <a href="actualizar_reparar.php?estado=<?php echo $estado?>&id4=<?php echo $id4?>&id3=<?php echo $id3?>&id2=<?php echo $id2?>&id=<?php echo $id?>&id_busqueda=<?php echo $id_busqueda?>" class="btn btn-primary">Actualizar</a> 
                    ...
                    <form action="Insertar_reparar.php" method="POST">
                            ...
                            <input type="submit" class="btn btn-primary btn-block" value="Reparar">
